...
//  init(custom: Any?, user: Sender, messageId: String, date: Date) {
...
//  }
//
//  init(imageURL: URL, user: Sender, messageId: String, date: Date) {
...
//  }
//
//  init(location: CLLocation, user: Sender, messageId: String, date: Date) {
//    let locationItem = CoordinateItem(location: location)
//    self.init(kind: .location(locationItem), user: user, messageId: messageId, date: date)
//  }
//
//  init(emoji: String, user: Sender, messageId: String, date: Date) {
//    self.init(kind: .emoji(emoji), user: user, messageId: messageId, date: date)
//  }
//
//  init(audioURL: URL, user: Sender, messageId: String, date: Date) {
//    let audioItem = MockAudioItem(url: audioURL)
//    self.init(kind: .audio(audioItem), user: user, messageId: messageId, date: date)
//  }
//
//  init(contact: MockContactItem, user: Sender, messageId: String, date: Date) {
//    self.init(kind: .contact(contact), user: user, messageId: messageId, date: date)
//  }
//
//  init(linkItem: LinkItem, user: Sender, messageId: String, date: Date) {
